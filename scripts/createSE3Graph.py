...
if __name__ == '__main__':
    ...
    default_vertex_location = directory + 'vertices_se3.txt'
    default_edges_location = directory + 'edges_se3.txt'
    edgeStates_location = directory + 'edges_viz_se3.txt'
    graph_save_location = directory + 'graph_se3_apartment.graphml'
